          ...
          try {
            ...
            if (err instanceof RefreshToken && !refreshed) {
              ...
              if (!data) {
                ...
                throw new Error(
                  'The channel was disconnected because its token expired, the user needs to reconnect it in Xperience Post'
                );
              }
            ...
            if (err instanceof RefreshToken) {
              throw new Error(
                'The provider rejected the credentials even after refreshing the token, the user needs to reconnect the channel in Xperience Post'
              );
            }
