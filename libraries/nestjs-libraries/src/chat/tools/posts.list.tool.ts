...
Posts cannot be deleted through the Xperience Post tools - if the user wants to delete a post, tell them to do it themselves in the Xperience Post app; never offer to delete a post.
`,
