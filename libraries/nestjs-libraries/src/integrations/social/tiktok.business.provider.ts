...
@Rules(
  [
    ...
    'Media is pulled by TikTok from its URL, so the media must be uploaded to Xperience Post and the media domain must be a verified URL property of the TikTok Business app.',
  ].join(' ')
)
